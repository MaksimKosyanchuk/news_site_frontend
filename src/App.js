...
function App() {
  ...
  const CssVariables = {
    ...
    '--input-text-color': isDarkTheme ? 'var(--gray-d7)' : 'black',
    ...
    '--active-drop-file-border': isDarkTheme ? 'var(--gray-b5)' : '#555555',
    '--submit-button-primary-color': isDarkTheme ? 'var(--gray-b5)' : 'rgb(55,55,55)',
