...
function App() {
  ...
  const CssVariables = {
    ...
    '--small-text-color': isDarkTheme ? 'var(--gray-b5)' : 'var(--gray-25)',
    '--author-name-color' : isDarkTheme ? 'var(--gray-d7)' : 'var(--gray-1e)',
    '--input-text-color': isDarkTheme ? 'var(--gray-d7)' : 'var(--gray-1e)',
    '--input-background-color': isDarkTheme ? 'var(--gray-1e)' : 'var(--gray-e7)',
    '--input-outline-color': isDarkTheme ? 'var(--gray-25)' : 'rgb(187, 187, 187)',
    '--input-outline-active-color': isDarkTheme ? 'var(--gray-b5)' : 'rgb(55, 55, 55)',
    '--input-placeholder-color': isDarkTheme ? 'var(--gray-4f)' : 'var(--gray-b5)',
    '--drop-file-background-color': isDarkTheme ? 'var(--gray-1e)' : 'var(--gray-e7)',
    '--drop-file-border-color': isDarkTheme ? 'var(--gray-4f)' : 'var(--gray-b5)',
    '--drop-file-hover-background-color': isDarkTheme ? 'var(--gray-25)' : 'var(--gray-d7)',
    '--drop-file-hover-border-color': isDarkTheme ? 'var(--gray-b5)' : 'var(--gray-63)',
    '--submit-button-primary-color': isDarkTheme ? 'var(--gray-b5)' : 'var(--gray-4f)',
    '--submit-button-primary-hover-color': isDarkTheme ? 'var(--gray-e7)' : 'var(--gray-25)',
